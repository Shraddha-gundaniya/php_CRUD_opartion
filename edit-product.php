<?php
    ...
    {
        header("loction:display-record.php");
    }
    $selectq =mysqli_query($conn,"select * from tbl_product where pro_id='{$editid}'") or die(mysqli_error($conn));
	...
	if($_POST)
	{
	  ...
	  $query =mysqli_query($conn,"update tbl_product set pro_name= '{$pname}',pro_price ='{$pprice}',pro_details='{$details}'where pro_id='{$id}'") or die(mysqli_error($conn));


	  if($query)
	  {
		echo "<script>alert('record upadted');window.location='display-record.php;'</script>";
	  }	  
	}
?>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <label for="inputEmail3" class="col-sm-2 control-label">product detail</label>
                                          <div class="col-sm-9">
                                             ...
                                             <div class="col-sm-offset-2"> <button type="submit" class="btn btn-default">update Product</button>
